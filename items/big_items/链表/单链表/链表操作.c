...
int main()
{
    struct Node **linkList = (struct Node **)malloc(sizeof(struct Node));
    int error = 0;
    // int size = 10;
    ...
    struct Node **newlinkList = (struct Node **)malloc(sizeof(struct Node));
    struct Node *nesw = (struct Node *)malloc(sizeof(struct Node));
    *newlinkList = nesw;
