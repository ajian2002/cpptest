...
# 1 "/usr/include/my/debug.info.h" 1 3 4
# 10 "hellotest.c" 2
...
# 19 "hellotest.c" 3 4
        ...
        time(&timer);
        pt = localtime(&timer);
        fprintf(fp, "[%04d-%02d-%02d][%02d:%02d:%02d][%s][%s][%2d]"
# 19 "hellotest.c"
                    "123%s"
                    "\n"
# 19 "hellotest.c" 3 4
                ,
                pt->tm_year + 1900, pt->tm_mon + 1, pt->tm_mday, pt->tm_hour, pt->tm_min, pt->tm_sec, "hellotest.c", __FUNCTION__, 19,
# 19 "hellotest.c"
                s
# 19 "hellotest.c" 3 4
        );
